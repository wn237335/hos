...
type User struct {
	...
	Password  string `gorm:"type:varchar(100);not null" json:"password" validate:"required,min=6,max=120" label:"密码"`
	...
	Address   string `gorm:"type:varchar(100);not null" json:"address" label:"家庭地址"`
...
func GetUsers(username string, pageSize int, pageNum int) ([]User, int64) {
	...
	db.Select("created_at,updated_at,id,username,telephone,email,address,role").Limit(pageSize).Offset((pageNum - 1) * pageSize).Find(&users)
